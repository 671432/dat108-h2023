...
public class Eksempel7 {
	...
	public static void main(String[] args) {
		...
		IntStream.iterate(100, x -> x+3).filter(x -> x%4 == 0).limit(10).forEach(x -> System.out.println(x+" "));
		...
		String s = Stream.of("Per", "Knut", "Anne", "Per").distinct().sorted().collect(Collectors.joining(" "));
		...
		System.out.println();
		System.out.println("Sorterte strenger uten duplikater");
//		List<String> ls = Stream.of("Per", "Knut", "Anne", "Per").distinct().
